...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-Z2SB5SV5.js";
import {
  require_lodash
} from "./chunk-PTD5N3IC.js";
import {
  ActionBar
} from "./chunk-EQK4IUWB.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-D5AAT42I.js";
import {
  SNIPPET_RENDERED,
  SourceType
} from "./chunk-OWOUM2VK.js";
import {
  O
} from "./chunk-YQBM3CJ3.js";
import {
  require_core_events
...
import {
  ...
  rgba
} from "./chunk-ZK5ZR74B.js";
import {
  require_pickBy
} from "./chunk-4DMYYGLY.js";
import {
  require_cloneDeep
} from "./chunk-MKO3AKC5.js";
import {
  require_preview_api
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-JFB5Q6XU.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-RQJUDNI5-O6SRQERB.js"));
...
var ArgControl = ({ row, arg, updateArgs, isHovered }) => {
  ...
  if (!control || control.disabled) {
    let canBeSetup = (control == null ? void 0 : control.disabled) !== true && ((_a = row == null ? void 0 : row.type) == null ? void 0 : _a.name) !== "function";
...
var Empty = ({ inAddonPanel }) => {
  ...
  }, []), isLoading ? null : import_react.default.createElement(Wrapper8, { inAddonPanel }, import_react.default.createElement(Content, null, import_react.default.createElement(Title2, null, inAddonPanel ? "Interactive story playground" : "Args table with interactive controls couldn't be auto-generated"), import_react.default.createElement(Description2, null, "Controls give you an easy to use interface to test your components. Set your story args and you'll see controls appearing here automatically.")), import_react.default.createElement(Links, null, inAddonPanel && import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(Link2, { href: "https://youtu.be/0gOfS6K0x0E", target: "_blank", withArrow: true }, import_react.default.createElement(VideoIcon, null), " Watch 5m video"), import_react.default.createElement(Divider, null), import_react.default.createElement(Link2, { href: "https://storybook.js.org/docs/essentials/controls", target: "_blank", withArrow: true }, import_react.default.createElement(DocumentIcon, null), " Read docs")), !inAddonPanel && import_react.default.createElement(Link2, { href: "https://storybook.js.org/docs/essentials/controls", target: "_blank", withArrow: true }, import_react.default.createElement(SupportIcon, null), " Learn how to set that up")));
};
...
var ArgTypes = (props) => {
  ...
  let mainComponentName = getComponentName(component), subcomponentTabs = (0, import_lodash.mapValues)(subcomponents, (comp) => ({ rows: (0, import_preview_api.filterArgTypes)(extractComponentArgTypes(comp, parameters), include, exclude), sort })), tabs = { [mainComponentName]: { rows: filteredArgTypes, sort }, ...subcomponentTabs };
...
var Controls3 = (props) => {
  ...
  let mainComponentName = getComponentName(component), subcomponentTabs = (0, import_lodash.mapValues)(subcomponents, (comp) => ({ rows: (0, import_preview_api.filterArgTypes)(extractComponentArgTypes2(comp, parameters), include, exclude), sort })), tabs = { [mainComponentName]: { rows: filteredArgTypes, sort }, ...subcomponentTabs };
...
}, [disable]), import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(Wrapper10, null, disable ? null : import_react.default.createElement(Content2, null, import_react.default.createElement(OptionalTitle, { title: title || null }), import_react.default.createElement("div", { className: "toc-wrapper" })))));
...
//# sourceMappingURL=chunk-YNTOMGE7.js.map
