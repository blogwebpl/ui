...
var LazySyntaxHighlighter = (0, import_react.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-JOJW2KGS-N2WSVYNH.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-JOJW2KGS-N2WSVYNH.js"), import("./formatter-B5HCVTEV-3ISIVAOV.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
var LazyWithTooltip = (0, import_react.lazy)(() => import("./WithTooltip-Y7J54OF7-RJMRXLPR.js").then((mod) => ({ default: mod.WithTooltip })));
...
var LazyWithTooltipPure = (0, import_react.lazy)(() => import("./WithTooltip-Y7J54OF7-RJMRXLPR.js").then((mod) => ({ default: mod.WithTooltipPure })));
...
var FlexBar = ({ children, backgroundColor, ...rest }) => {
  ...
  return import_react.default.createElement(Bar, { ...rest }, import_react.default.createElement(BarInner, { bgColor: backgroundColor }, import_react.default.createElement(Side, { scrollable: rest.scrollable, left: true }, left), right ? import_react.default.createElement(Side, { right: true }, right) : null));
};
...
function useList(list) {
  let tabBarRef = (0, import_react.useRef)(), addonsRef = (0, import_react.useRef)(), tabRefs = (0, import_react.useRef)(/* @__PURE__ */ new Map()), { width: tabBarWidth = 1 } = useResizeObserver({ ref: tabBarRef }), [visibleList, setVisibleList] = (0, import_react.useState)(list), [invisibleList, setInvisibleList] = (0, import_react.useState)([]), previousList = (0, import_react.useRef)(list), AddonTab = (0, import_react.useCallback)(({ menuName, actions }) => {
    ...
    return import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(WithToolTipState, { interactive: true, visible: isTooltipVisible, onVisibleChange: setTooltipVisible, placement: "bottom", delayHide: 100, tooltip: import_react.default.createElement(TooltipLinkList, { links: invisibleList.map(({ title, id, color: color2, active }) => ({ id, title, color: color2, active, onClick: (e) => {
      ...
      return import_react.default.createElement(TabButton, { id: `tabbutton-${L(id) ?? indexId}`, style: { visibility: "hidden" }, "aria-hidden": true, tabIndex: -1, ref: (ref) => {
...
var Tabs = (0, import_react.memo)(({ children, selected, actions, absolute, bordered, tools, backgroundColor, id: htmlId, menuName }) => {
  let idList = childrenToList(children).map((i) => i.id).join(","), list = (0, import_react.useMemo)(() => childrenToList(children).map((i, index3) => ({ ...i, active: selected ? i.id === selected : index3 === 0 })), [selected, idList]), { visibleList, tabBarRef, tabRefs, AddonTab } = useList(list);
  return list.length ? import_react.default.createElement(Wrapper2, { absolute, bordered, id: htmlId }, import_react.default.createElement(FlexBar, { scrollable: false, border: true, backgroundColor }, import_react.default.createElement(TabBar, { style: { whiteSpace: "normal" }, ref: tabBarRef, role: "tablist" }, visibleList.map(({ title, id, active, color: color2 }, index3) => {
    let indexId = `index-${index3}`;
    return import_react.default.createElement(TabButton, { id: `tabbutton-${L(id) ?? indexId}`, ref: (ref) => {
      tabRefs.current.set(id, ref);
  ...
  }), import_react.default.createElement(AddonTab, { menuName, actions })), tools), import_react.default.createElement(Content, { id: "panel-tab-content", bordered, absolute }, list.map(({ id, active, render }) => import_react.default.createElement(render, { key: id, active }, null)))) : import_react.default.createElement(Placeholder, null, import_react.default.createElement(import_react.Fragment, { key: "title" }, "Nothing found"));
});
...
//# sourceMappingURL=chunk-Z2SB5SV5.js.map
