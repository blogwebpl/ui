...
const Template = (props) => {
    ...
    return (_jsx(Router, { children: _jsx(Main, { isCovered: true, isDrawerOpen: false, setIsDrawerOpen: () => { }, children: _jsx(EditForm, Object.assign({}, props, { title: { pl: 'Edycja', en: 'Edit' }, tabs: tabs, activeTab: 0, fields: fields, values: values, language: "en", collection: "test", roles: roles, menuItems: menuItems, permissions: permissions, menus: menus, saveData: (data) => {
                    console.log(data);
                ...
                }, inventoryItems: exampleInventoryItems, width: "90rem", users: users })) }) }));
};
export default { component: Template, title: 'EditForm' };
export const Default = {};
export const ReadOnly = { args: { mode: 'view' } };
//# sourceMappingURL=EditForm.stories.js.map