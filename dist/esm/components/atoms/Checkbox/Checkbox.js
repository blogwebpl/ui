...
export const Checkbox = React.memo((props) => {
    if (props.controlled)
        return (_jsxs(StyledCheckbox, { className: "checkbox", children: [_jsx("input", { type: "checkbox", checked: props.checked, onChange: (e) => {
                        props.onChange(e.target.checked);
                    }, ref: props.forwardedRef, onClick: (e) => {
                        e.stopPropagation();
                    } }), _jsx("span", { children: props.label })] }));
    return (_jsxs(StyledCheckbox, { className: "checkbox", children: [_jsx("input", { type: "checkbox", defaultChecked: props.checked, ref: props.forwardedRef, onClick: (e) => {
                    e.stopPropagation();
                } }), _jsx("span", { children: props.label })] }));
});
