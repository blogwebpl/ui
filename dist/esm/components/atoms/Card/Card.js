...
const StyledCard = styled.div `
	...
	background-color: ${(props) => props.$opacity ? 'rgba(255, 255, 255, 0.9)' : props.theme.palette.background.default};
...
export function Card(props) {
    return (_jsx(StyledCard, { "$padding": props.padding, "$minwidth": props.minWidth, "$opacity": props.opacity, "$isPending": props.isPending, children: props.children }));
}
